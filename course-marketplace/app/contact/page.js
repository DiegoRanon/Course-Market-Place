              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">support@coursemarketplace.com</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    We offer a 30-day money-back guarantee for all paid subscriptions. Contact our support team for assistance.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-medium text-gray-900">How do I access my courses?</h3>
                  <p className="text-gray-600 mt-1">
                    After logging in, go to your dashboard to see all your enrolled courses and continue learning.
                  </p>
                </div>
              </div>
            </div>
