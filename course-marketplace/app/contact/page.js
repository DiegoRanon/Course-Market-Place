            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    We offer a 30-day money-back guarantee for all paid
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    After logging in, go to your dashboard to see all your
                    enrolled courses and continue learning.
                  </p>
                </div>
              </div>
            </div>
