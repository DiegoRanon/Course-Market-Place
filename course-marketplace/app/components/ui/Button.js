...
export default function Button({
  ...
  const variantStyles = {
    primary: "bg-purple-600 text-white hover:bg-purple-700 focus:ring-2 focus:ring-offset-2 focus:ring-purple-500",
    ...
    outline: "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-2 focus:ring-offset-2 focus:ring-purple-500",
  };
